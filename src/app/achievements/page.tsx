...
const RUST_ACHIEVEMENTS: Achievement[] = [
  {
    id: "rs-hello",
    title: "Hello, Rust",
    description: "Complete Day 1",
  ...
  {
    id: "rs-ownership",
    title: "Ownership Master",
    description: "Complete Day 9 (Ownership)",
    icon: Box,
    condition: (s) => s.completedDays.includes(9),
    xp: 150,
    rarity: "rare",
  },
  {
    ...
    description: "Complete Day 12 (Structs)",
    icon: Layers,
    condition: (s) => s.completedDays.includes(12),
    xp: 150,
    rarity: "rare",
  },
  {
    id: "rs-traits",
    title: "Trait Wizard",
    description: "Reach Day 16 (Traits)",
    icon: Workflow,
    condition: (s) => s.completedDays.some((d) => d >= 16),
    xp: 200,
    rarity: "rare",
  },
  {
  ...
  },
  {
    id: "rs-error",
    title: "Calm Under Errors",
    description: "Complete Day 21 (Result)",
    icon: Shield,
    condition: (s) => s.completedDays.includes(21),
    xp: 200,
    rarity: "rare",
  ...
  {
    id: "rs-iterators",
    title: "Iterator Explorer",
    description: "Complete Day 23 (Iterators)",
    icon: Cpu,
    condition: (s) => s.completedDays.includes(23),
    xp: 250,
    rarity: "epic",
  },
  {
    ...
    description: "Reach Day 34 (Threads)",
    icon: Server,
    condition: (s) => s.completedDays.some((d) => d >= 34),
    xp: 300,
    rarity: "epic",
...
const SQL_ACHIEVEMENTS: Achievement[] = [
  {
    id: "sql-hello",
    title: "Hello, Data",
    description: "Complete Day 1",
  ...
  {
    id: "sql-select",
    title: "Select Prophet",
    description: "Reach Day 3 (SELECT)",
    icon: Table2,
    condition: (s) => s.completedDays.some((d) => d >= 3),
    xp: 150,
    rarity: "rare",
  },
  {
    id: "sql-aggregates",
    title: "Aggregate Apprentice",
    description: "Reach Day 6 (GROUP BY)",
    icon: Binary,
    condition: (s) => s.completedDays.some((d) => d >= 6),
    xp: 150,
    rarity: "rare",
  },
  {
    ...
    description: "Reach Day 13 (Constraints)",
    icon: Shield,
    condition: (s) => s.completedDays.some((d) => d >= 13),
    xp: 200,
    rarity: "rare",
  },
  {
  ...
  },
  {
    id: "sql-joins",
    title: "Join Master",
    description: "Complete Day 16 (INNER JOIN)",
    icon: Workflow,
    condition: (s) => s.completedDays.includes(16),
    xp: 250,
    rarity: "rare",
  },
  {
    id: "sql-indexes",
    title: "Index Whisperer",
    description: "Reach Day 27 (Indexes)",
    icon: Cpu,
    condition: (s) => s.completedDays.some((d) => d >= 27),
    xp: 250,
    rarity: "epic",
  },
  {
    ...
    description: "Reach Day 28 (Transactions)",
    icon: Server,
    condition: (s) => s.completedDays.some((d) => d >= 28),
    xp: 250,
    rarity: "epic",
...
const BASH_ACHIEVEMENTS: Achievement[] = [
  {
    id: "bash-hello",
    title: "Hello, Shell",
    description: "Complete Day 1",
  ...
  {
    id: "bash-redirect",
    title: "Redirection Ace",
    description: "Reach Day 5 (Redirection)",
    icon: HardDrive,
    condition: (s) => s.completedDays.some((d) => d >= 5),
    xp: 150,
    rarity: "rare",
  },
  {
  ...
  },
  {
    id: "bash-functions",
    title: "Function Builder",
    description: "Reach Day 14 (Functions)",
    icon: Braces,
    condition: (s) => s.completedDays.some((d) => d >= 14),
    xp: 200,
    rarity: "rare",
  },
  {
  ...
  {
    id: "bash-git",
    title: "Version Visionary",
    description: "Reach Day 23 (git)",
    icon: GitBranch,
    condition: (s) => s.completedDays.some((d) => d >= 23),
    xp: 250,
    rarity: "epic",
  },
  {
    id: "bash-scripts",
    title: "Script Author",
    description: "Reach Day 34 (Scripting)",
    icon: FileCode2,
    condition: (s) => s.completedDays.some((d) => d >= 34),
    xp: 300,
    rarity: "epic",
...
const ACHIEVEMENT_SETS: Record<TrackKey, Achievement[]> = {
  ...
  js: JS_ACHIEVEMENTS,
  rust: RUST_ACHIEVEMENTS,
  sql: SQL_ACHIEVEMENTS,
  bash: BASH_ACHIEVEMENTS,
};
